 ...
 * Step 1: Client card (no duplicate “CLIENT” label); DTC map ~600px, ~50% opacity, behind content, nudged left; personal care right; no network column; “chooses…” one step larger than Step 2.
...
/** Step 1 — same dark Client card as Step 2 but without the small uppercase “CLIENT” line; “chooses…” one size larger than Step 2’s text-sm. DTC map as background layer (not in layout flow), ~50% opacity. */

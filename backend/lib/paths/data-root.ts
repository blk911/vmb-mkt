// backend/lib/paths/data-root.ts
 ...
 * Uses process.cwd() which is the repo root when running from Next.js or Node scripts.
 */
export function repoRootAbs() {
  // In Next.js and Node scripts, process.cwd() is the repo root
  return process.cwd();
}
